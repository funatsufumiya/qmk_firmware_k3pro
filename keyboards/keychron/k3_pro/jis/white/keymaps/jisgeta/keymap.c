...
const PROGMEM naginata_keymap ngmap[] = { // 新下駄
  ...
  {.key = KB_K|KB_W        , .kana = "go"},
  {.key = KB_K|KB_E        , .kana = "hu"},
  {.key = KB_K|KB_R        , .kana = "fi"},
  {.key = KB_K|KB_T        , .kana = "fe"},
  {.key = KB_D|KB_Y        , .kana = "wi"},
  {.key = KB_D|KB_U        , .kana = "pa"},
  {.key = KB_D|KB_I        , .kana = "yo"},
  {.key = KB_D|KB_O        , .kana = "mi"},
  {.key = KB_D|KB_P        , .kana = "we"},
  {.key = KB_D|KB_X1       , .kana = "ulo"},

  {.key = KB_K|KB_A        , .kana = "ho"},
  {.key = KB_K|KB_S        , .kana = "ji"},
  {.key = KB_K|KB_D        , .kana = "re"},
  {.key = KB_K|KB_F        , .kana = "mo"},
  {.key = KB_K|KB_G        , .kana = "yu"},
  {.key = KB_D|KB_H        , .kana = "he"},
  {.key = KB_D|KB_J        , .kana = "a"},
  {.key = KB_D|KB_K        , .kana = ""},
  {.key = KB_D|KB_L        , .kana = "o"},
  {.key = KB_D|KB_SCLN     , .kana = "e"},

  {.key = KB_K|KB_Z        , .kana = "du"},
  {.key = KB_K|KB_X        , .kana = "zo"},
  {.key = KB_K|KB_C        , .kana = "bo"},
  {.key = KB_K|KB_V        , .kana = "mu"},
  {.key = KB_K|KB_B        , .kana = "fo"},
  {.key = KB_D|KB_N        , .kana = "se"},
  {.key = KB_D|KB_M        , .kana = "ne"},
  {.key = KB_D|KB_COMM     , .kana = "be"},
  {.key = KB_D|KB_DOT      , .kana = "pu"},
  {.key = KB_D|KB_SLSH     , .kana = "vu"},
  ...
  {.key = KB_S|KB_Y        , .kana = "sye"},
  {.key = KB_S|KB_U        , .kana = "pe"},
  {.key = KB_S|KB_I        , .kana = "do"},
  {.key = KB_S|KB_O        , .kana = "ya"},
  {.key = KB_S|KB_P        , .kana = "je"},

  {.key = KB_L|KB_A        , .kana = "wo"},
  {.key = KB_L|KB_S        , .kana = "sa"},
  {.key = KB_L|KB_D        , .kana = "o"},
  {.key = KB_L|KB_F        , .kana = "ri"},
  {.key = KB_L|KB_G        , .kana = "zu"},
  {.key = KB_S|KB_H        , .kana = "bi"},
  {.key = KB_S|KB_J        , .kana = "ra"},
  {.key = KB_S|KB_K        , .kana = ""},
  {.key = KB_S|KB_L        , .kana = ""},
  {.key = KB_S|KB_SCLN     , .kana = "so"},

  {.key = KB_L|KB_Z        , .kana = "ze"},
  {.key = KB_L|KB_X        , .kana = "za"},
  {.key = KB_L|KB_C        , .kana = "gi"},
  {.key = KB_L|KB_V        , .kana = "ro"},
  {.key = KB_L|KB_B        , .kana = "nu"},
  {.key = KB_S|KB_N        , .kana = "wa"},
  {.key = KB_S|KB_M        , .kana = "da"},
  {.key = KB_S|KB_COMM     , .kana = "pi"},
  {.key = KB_S|KB_DOT      , .kana = "po"},
  {.key = KB_S|KB_SLSH     , .kana = "tile"},

  {.key = KB_L|KB_1        , .kana = "xya"},
  {.key = KB_L|KB_2        , .kana = "mya"},
  {.key = KB_L|KB_3        , .kana = "myu"},
  {.key = KB_L|KB_4        , .kana = "myo"},
  {.key = KB_L|KB_5        , .kana = "xwa"},

  {.key = KB_I|KB_E     , .kana = "sho"},
  {.key = KB_I|KB_W     , .kana = "shu"},
  {.key = KB_I|KB_R     , .kana = "kyu"},
  {.key = KB_I|KB_F     , .kana = "kyo"},
  {.key = KB_I|KB_V     , .kana = "kya"},
  {.key = KB_I|KB_C     , .kana = "sha"},
  {.key = KB_I|KB_Q     , .kana = "hyu"},
  {.key = KB_I|KB_A     , .kana = "hyo"},
  {.key = KB_I|KB_Z     , .kana = "hya"},
  {.key = KB_I|KB_T     , .kana = "chu"},
  {.key = KB_I|KB_G     , .kana = "cho"},
  {.key = KB_I|KB_B     , .kana = "cha"},

  {.key = KB_I|KB_1     , .kana = "xyu"},
  {.key = KB_I|KB_2     , .kana = "bya"},
  {.key = KB_I|KB_3     , .kana = "byu"},
  {.key = KB_I|KB_4     , .kana = "byo"},

  {.key = KB_O|KB_E     , .kana = "jo"},
  {.key = KB_O|KB_W     , .kana = "ju"},
  {.key = KB_O|KB_R     , .kana = "gyu"},
  {.key = KB_O|KB_F     , .kana = "gyo"},
  {.key = KB_O|KB_V     , .kana = "gya"},
  {.key = KB_O|KB_C     , .kana = "ja"},
  {.key = KB_O|KB_Q     , .kana = "ryu"},
  {.key = KB_O|KB_A     , .kana = "ryo"},
  {.key = KB_O|KB_Z     , .kana = "rya"},
  {.key = KB_O|KB_T     , .kana = "nyu"},
  {.key = KB_O|KB_G     , .kana = "nyo"},
  {.key = KB_O|KB_B     , .kana = "nya"},

  {.key = KB_O|KB_1     , .kana = "xyo"},
  {.key = KB_O|KB_2     , .kana = "pya"},
  {.key = KB_O|KB_3     , .kana = "pyu"},
  {.key = KB_O|KB_4     , .kana = "pyo"},
